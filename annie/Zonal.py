...
CARBON_FACTORS = {
    ...
    'waste_to_energy':  580,
    'EU_import':        250,
    # load_shedding intentionally omitted: NaN EI → excluded from Bialek local_gen
}
...
# ─────────────────────────────────────────────────────────────────────────────
# STEP 1: Load the network (keep full 17-zone structure — no bus collapse)
# ─────────────────────────────────────────────────────────────────────────────
...
# Sanity check: generation ≈ demand (nationally)
...
# ── Pre-compute per-zone generation & emissions (vectorised) ─────────────────
...
# ── Panel E: National generation mix (area chart) ───────────────────────────
